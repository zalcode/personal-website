...
export default function TechStack() {
  const languages: TechItem[] = [
    ...
    {
      name: "CSS",
      icon: <SiCss3 className="w-8 h-8 text-blue-400" />,
      proficiency: 90,
    },
    {
      name: "PHP",
      icon: <SiPhp className="w-8 h-8 text-purple-500" />,
      proficiency: 75,
    },
    {
      name: "ReasonML",
      icon: (
        <div className="w-8 h-8 flex items-center justify-center text-red-500 font-bold">
          Re
        </div>
      ),
      proficiency: 80,
  ...
  const frameworks: TechItem[] = [
    ...
    },
    {
      ...
      icon: <SiReact className="w-8 h-8 text-purple-400" />,
      proficiency: 80,
    },
    {
      name: "Node.js",
    ...
    {
      name: "Material UI",
      icon: <SiMui className="w-8 h-8 text-blue-600" />,
      proficiency: 85,
    },
    {
      name: "Bootstrap",
      icon: <SiBootstrap className="w-8 h-8 text-purple-600" />,
      proficiency: 85,
    },
    {
      name: "Laravel",
  ...
  const tools: TechItem[] = [
    {
      name: "NX Monorepo",
      icon: <SiNx className="w-8 h-8" />,
      proficiency: 85,
    },
    {
      name: "Turborepo",
      icon: <SiTurborepo className="w-8 h-8" />,
      proficiency: 85,
    },
    {
      name: "Zustand",
      icon: (
        <div className="w-8 h-8 flex items-center justify-center text-amber-600 font-bold">
          Z
        </div>
      ),
      proficiency: 90,
    ...
    },
    {
      name: "Tamagui",
      icon: (
        <div className="w-8 h-8 flex items-center justify-center text-purple-600 font-bold">
          T
        </div>
      ),
      proficiency: 80,
    ...
    {
      name: "Prisma",
      icon: <SiPrisma className="w-8 h-8 text-teal-500" />,
      proficiency: 75,
    },
    {
      name: "PostgreSQL",
      icon: <SiPostgresql className="w-8 h-8 text-blue-600" />,
      proficiency: 75,
    },
    {
      name: "MySQL",
    ...
    {
      name: "Redis",
      icon: <SiRedis className="w-8 h-8 text-red-600" />,
      proficiency: 70,
    },
  ];
